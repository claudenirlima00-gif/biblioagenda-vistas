      ...
      return (
        <div className="min-h-screen flex items-center justify-center bg-slate-50 p-6">
          <div className="bg-white p-12 rounded-[3rem] shadow-2xl border border-slate-100 max-w-md w-full text-center space-y-6">
            <div className="bg-red-50 w-20 h-20 rounded-[2rem] flex items-center justify-center mx-auto text-red-600">
            ...
            <button 
              ...
              className="w-full bg-[#800000] text-white py-4 rounded-2xl font-black uppercase tracking-widest text-xs hover:bg-slate-900 transition-all"
            >
